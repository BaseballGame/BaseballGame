...
public class GUI{
	...
	//
	private static JTextField[] tfPreviousPlayPitches;
	private static JLabel[] lblPreviousPlayPitches;
	public JTextField getTfPreviousPlayPitches(int i) {
		return tfPreviousPlayPitches[i];
	}
	public static void setTfPreviousPlayPitches(int i, String string) {
		tfPreviousPlayPitches[i].setText(string);
	}
	...
	// private Dimension initScreenSize; //
	...
	// // make frame fit screen

	// private void makeFrameFitScreen(JLabel frame) {
	// 	Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
	// 	double widthRatio = frame.getWidth() / initScreenSize.width;
	// 	double heightRatio = frame.getHeight() / initScreenSize.height;
	// 	frame.setSize((int)(screenSize.width * widthRatio), (int)(screenSize.height * heightRatio));

	// }

	// public void resizeFrames() {

	// 	this.makeFrameFitScreen(lblBoxStatus);
	// 	// this.makeFrameFitScreen(batterPanel);
	// 	this.makeFrameFitScreen(lblVersus);
	...
	private void initialize() {
      ...
      getFrame().getContentPane().setBackground(new Color(153,102,0));
      ...
      scoreboardPanel.setBackground(new Color(0,153,0));
      ...
      boxStatusPanel.setBackground(new Color(0,153,0));
      ...
      previousPlayPanel.setBackground(new Color(0,153,0));
		...
		//
		lblPreviousPlayPitches = new JLabel[3];
		tfPreviousPlayPitches = new JTextField[3];
		int[] yPitches = {97, 146, 189};

		// JLabel lblPreviousPlayPitch[3];
		for (int i = 0; i < 3; i ++) {
			lblPreviousPlayPitches[i] = new JLabel("Pitch " + (i + 1) + ":");
			
			lblPreviousPlayPitches[i].setFont(new Font("Tahoma", Font.PLAIN, 20));
			lblPreviousPlayPitches[i].setBounds(20, yPitches[i], 44, 32);
			previousPlayPanel.add(lblPreviousPlayPitches[i]);
			
			tfPreviousPlayPitches[i] = new JTextField();
			tfPreviousPlayPitches[i].setFont(new Font("Tahoma", Font.PLAIN, 16));
			tfPreviousPlayPitches[i].setEditable(false);
			tfPreviousPlayPitches[i].setColumns(10);
			tfPreviousPlayPitches[i].setBounds(100, yPitches[i], 168, 30);
			previousPlayPanel.add(tfPreviousPlayPitches[i]);
		}
      ...
      awayPanel.setBackground(new Color(0,153,0));
      ...
      homePanel.setBackground(new Color(0,153,0));
      ...
      batterPanel.setBackground(new Color(0,153,0));
		...
		Component [] components = {
			...
			// tfHomePitcher,
			// tfHomeERA,
			// tfPreviousPlayBatter,
			// tfPreviousPlayResult,
			// tfPreviousPlayOuts,
			// tfBatter,
			// tfPitcher,
			// tfAtBats,
		...
		currentFrameHeight = frmBaseball.getHeight();
		currentFrameWidth = frmBaseball.getWidth();
		...
		frmBaseball.addComponentListener(new ComponentAdapter(){ 
			public void componentResized(ComponentEvent e) {
				// int newFrameHeight = frmBaseball.getHeight();
				// int newFrameWidth = frmBaseball.getWidth();
				float heightRatio;
				heightRatio = ((float) frmBaseball.getHeight()) / currentFrameHeight;

				float widthRatio = ((float) frmBaseball.getWidth()) / currentFrameWidth;

				if (heightRatio != 1.0) System.out.println("heightRatio = " + heightRatio);
				if (widthRatio != 1.0) System.out.println("widthRatio = " + widthRatio);
				System.out.println("currentFrameHeight = " + currentFrameHeight + " currentFrameWidth = " + currentFrameWidth);
				...
				System.out.println(currentFrameHeight + ", " + currentFrameWidth);
		...
		// initScreenSize = Toolkit.getDefaultToolkit().getScreenSize(); //  
