...
public class BaseballGame{
   ...
   public enum PlayResult{SINGLE, DOUBLE, TRIPLE, HOMER,
	   WALK, STRIKEOUT, FLYOUT, SACFLY,
	   POPOUT, GROUNDOUT, DOUBLEPLAY};
   ...
   public static void getNextPlayUpdateStats(){//Gets the next play and updates guis and stats based on the play
      ...
      int Pdie;
      Pdie= roll();
      GUI.setTfPreviousPlayPitches(1, pitchTypes[Pdie - 1]);
         ...
         case 2:
            switch(die2){
               ...
               case 6:
                  ...
                  GUI.setTfPreviousPlayPitches(1, "");
   ...
   public void initTeams() {//Imports the default players to their respective teams
   ...
   public void initNextBatter() {//Initializes gui components for the next and previous batters and gets the next play for the batter
      if(walkingToPlate == 0) { //Only occurs when the previous play didnt result in a new half inning starting
         ...
         GUI.setTfPreviousPlayPitches(1, " "); //j//
