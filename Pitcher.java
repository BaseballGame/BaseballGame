...
public class Pitcher extends BaseballPlayer{
   ...
   // public string getPitchType(){//Last Pitch Type
   //    return lastPitchType;
   // }
   ...
   public void generateRandomPitch(){ //Generates random Pitch Type
      String[] pitchTypes = {"Fastball",
                     "changeup",
                     "curveball",
                     "knuckleball",
                     "slider"};
      int rnd = new Random().nextInt(pitchTypes.length);
      lastPitchType = pitchTypes[rnd];
   }
